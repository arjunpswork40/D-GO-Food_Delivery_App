...
class controller {
    ...
    static async allFoods(req, res, next) {
      ...
      static async newCustomer(req, res, next) {
        ...
        try {
            ...
            return res.status(201).json(makeJsonResponse('Success', {}, { message: "User created successfully", user: auth.authJSON(newUser) }, 201, true));
    ...
    static async newDeliveryPartner(req, res, next) {
        ...
        try {
            ...
            return res.status(201).json(makeJsonResponse('Success', {}, { message: "Delivery Partner created successfully", user: auth.authJSON(newUser) }, 201, true));
